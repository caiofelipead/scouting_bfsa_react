...
export default function ContractImpactPage() {
  ...
  return (
    <div className="space-y-5">
      ...
      {/* Input form — backdropFilter desabilitado para permitir z-index do dropdown */}
          ...
          <div style={{ position: 'relative', zIndex: 20 }}>
            ...
            <div className="relative">
              ...
              {debouncedSearch.length >= 2 && !selectedPlayer && players.length > 0 && (
                <div className="absolute top-full left-0 right-0 mt-1 rounded overflow-hidden max-h-48 overflow-y-auto" style={{ zIndex: 9999, background: 'var(--color-surface-1)', border: '1px solid var(--color-border-active)', boxShadow: '0 8px 32px rgba(0,0,0,0.5)' }}>
                  {players.map((p, i) => (
